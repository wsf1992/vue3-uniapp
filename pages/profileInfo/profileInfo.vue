	...
	<view>
		<uni-section class="title" title="用户信息" titleFontSize="12px" titleColor="#666">
			<uni-list>
				...
				<uni-list-item showArrow title="用户名" :rightText="userForm.username" class="list-item" link to="/pages/setusername/setusername" />
		...
		<uni-section class="title" title="账号绑定" titleFontSize="12px" titleColor="#666">
			<uni-list>
				<uni-list-item showArrow title="手机" thumb="../../static/phone.png" thumb-size="sm" class="list-item" clickable @click="setPhone">
		...
		<uni-section class="title" title="安全设置" titleFontSize="12px" titleColor="#666">
			<uni-list><uni-list-item showArrow title="登录密码" rightText="修改" class="list-item" link to="/pages/forget/forget" /></uni-list>
		</uni-section>
...
<script setup>
import { getUserInfo, signout, avatar } from '@/common/fetch.js';
...
.list-item >>> .uni-list-item__container {
